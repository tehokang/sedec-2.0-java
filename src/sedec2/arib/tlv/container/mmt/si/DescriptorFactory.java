...
import sedec2.arib.tlv.container.mmt.si.descriptors.AccessControlDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.ApplicationServiceDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.AssetGroupDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.BackgroundColorDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.ContentCopyControlDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.ContentUsageControlDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.DependencyDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.Descriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.EmergencyInformationDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.EmergencyNewsDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.EventMessageDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.EventPackageDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.IpDataFlowDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.LinkedPuDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.LockedCacheDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ApplicationBoundaryAndPermissionDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ApplicationDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ApplicationExpirationDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_AudioComponentDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_AutostartPriorityDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_BroadcasterNameDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_CAContractInfoDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_CAServiceDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_CAStartupDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_CacheControlInfoDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ComponentGroupDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_CompressionTypeDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ContentDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_DataComponentDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_DownloadProtectionDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_EventGroupDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ExpireDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ExtendedEventDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ExternalApplicationControlDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_HEVCDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_HierachyDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_InfoDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_LinkageDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_LocalTimeOffsetDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_LogoTransmissionDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_MPEG4AudioDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_MPEG4AudioExtensionDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_NetworkDownloadContentDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ParentalRatingDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_PlaybackApplicationDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_RandomizedLatencyDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_SeriesDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ServiceDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ServiceListDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_ShortEventDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_SiParameterDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_SimpleApplicationLocationDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_SimplePlaybackApplicationLocationDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_StreamIdentifierDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_TargetRegionDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_TransportProtocolDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MH_TypeDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MPU_DownloadContentDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MPU_ExtendedTimestampDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MPU_NodeDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MPU_PresentationRegionDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MPU_TimestampDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MessageAuthenticationMethodDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.MultimediaServiceInformationDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.PUStructureDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.RelatedBroadcasterDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.ScramblerDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.UnknownDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.UnlockedCacheDescriptor;
import sedec2.arib.tlv.container.mmt.si.descriptors.UtcNptReferenceDescriptor;
