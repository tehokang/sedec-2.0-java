 ...
 */
public class FileTlvPacketReader extends FilePacketReader {
    protected static final String TAG = FileTlvPacketReader.class.getSimpleName();
     ...
     */
    public FileTlvPacketReader(String tlv_file) {
        super(tlv_file);
    }
