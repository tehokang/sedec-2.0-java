...
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.CRC32Descriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.CachingPriorityDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.CompressedModuleDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.EstimatedDownloadTimeDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.GroupLinkDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.InfoDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.LocationDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.ModuleLinkDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.NameDescriptor;
import sedec2.dvb.ts.dsmcc.objectcarousel.messages.descriptors.TypeDescriptor;
