...
public class DSMCCSection extends Table {
    ...
    public void updateToDataCarousel() {
        message = sedec2.arib.tlv.container.mmt.si.tables.dsmcc.datacarousel.MessageFactory.createMessage(message_byte);
    }

    public void updateToObjectCarousel() {
        message = sedec2.arib.tlv.container.mmt.si.tables.dsmcc.objectcarousel.MessageFactory.createMessage(message_byte);
    }
