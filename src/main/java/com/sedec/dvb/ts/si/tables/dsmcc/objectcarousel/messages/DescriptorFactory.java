package com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages;

import com.sedec.base.BitReadWriter;
import com.sedec.base.Descriptor;
import com.sedec.dvb.ts.si.descriptors.UnknownDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.CRC32Descriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.CachingPriorityDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.CompressedModuleDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.EstimatedDownloadTimeDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.GroupLinkDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.InfoDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.LocationDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.ModuleLinkDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.NameDescriptor;
import com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.messages.descriptors.TypeDescriptor;
