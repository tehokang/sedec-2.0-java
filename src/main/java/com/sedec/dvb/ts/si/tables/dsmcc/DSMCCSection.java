...
public class DSMCCSection extends Table {
    ...
    public void updateToDataCarousel() {
        message = com.sedec.dvb.ts.si.tables.dsmcc.datacarousel.MessageFactory.createMessage(message_byte);
    }

    public void updateToObjectCarousel() {
        message = com.sedec.dvb.ts.si.tables.dsmcc.objectcarousel.MessageFactory.createMessage(message_byte);
    }
