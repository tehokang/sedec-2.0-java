...
import com.sedec.dvb.ts.si.descriptors.AC3Descriptor;
import com.sedec.dvb.ts.si.descriptors.AdaptationFieldDataDescriptor;
import com.sedec.dvb.ts.si.descriptors.AncillaryDataDescriptor;
import com.sedec.dvb.ts.si.descriptors.ApplicationDescriptor;
import com.sedec.dvb.ts.si.descriptors.ApplicationNameDescriptor;
import com.sedec.dvb.ts.si.descriptors.ApplicationRecordingDescriptor;
import com.sedec.dvb.ts.si.descriptors.ApplicationSignallingDescriptor;
import com.sedec.dvb.ts.si.descriptors.ApplicationUsageDescriptor;
import com.sedec.dvb.ts.si.descriptors.AssociationTagDescriptor;
import com.sedec.dvb.ts.si.descriptors.BouquetNameDescriptor;
import com.sedec.dvb.ts.si.descriptors.CAIdentifierDescriptor;
import com.sedec.dvb.ts.si.descriptors.CableDeliverySystemDescriptor;
import com.sedec.dvb.ts.si.descriptors.CarouselIdentifierDescriptor;
import com.sedec.dvb.ts.si.descriptors.CellListDescriptor;
import com.sedec.dvb.ts.si.descriptors.ComponentDescriptor;
import com.sedec.dvb.ts.si.descriptors.ConditionalAccessDescriptor;
import com.sedec.dvb.ts.si.descriptors.ConnectionRequirementDescriptor;
import com.sedec.dvb.ts.si.descriptors.ContentDescriptor;
import com.sedec.dvb.ts.si.descriptors.CountryAvailabilityDescriptor;
import com.sedec.dvb.ts.si.descriptors.DataBroadcastDescriptor;
import com.sedec.dvb.ts.si.descriptors.DataBroadcastIdDescriptor;
import com.sedec.dvb.ts.si.descriptors.DataComponentDescriptor;
import com.sedec.dvb.ts.si.descriptors.DeferredAssociationTagsDescriptor;
import com.sedec.dvb.ts.si.descriptors.Descriptor;
import com.sedec.dvb.ts.si.descriptors.DigitalCopyControlDescriptor;
import com.sedec.dvb.ts.si.descriptors.EnhancedAC3Descriptor;
import com.sedec.dvb.ts.si.descriptors.ExtendedEventDescriptor;
import com.sedec.dvb.ts.si.descriptors.FrequencyListDescriptor;
import com.sedec.dvb.ts.si.descriptors.ISO639LanguageDescriptor;
import com.sedec.dvb.ts.si.descriptors.LinkageDescriptor;
import com.sedec.dvb.ts.si.descriptors.LocalTimeOffsetDescriptor;
import com.sedec.dvb.ts.si.descriptors.MultilingualBouquetNameDescriptor;
import com.sedec.dvb.ts.si.descriptors.MultilingualComponentDescriptor;
import com.sedec.dvb.ts.si.descriptors.MultilingualNetworkNameDescriptor;
import com.sedec.dvb.ts.si.descriptors.MultilingualServiceNameDescriptor;
import com.sedec.dvb.ts.si.descriptors.NVODReferenceDescriptor;
import com.sedec.dvb.ts.si.descriptors.NetworkNameDescriptor;
import com.sedec.dvb.ts.si.descriptors.PDCDescriptor;
import com.sedec.dvb.ts.si.descriptors.ParentalRatingDescriptor;
import com.sedec.dvb.ts.si.descriptors.PrivateDataSpecifierDescriptor;
import com.sedec.dvb.ts.si.descriptors.S2SateliteDeliverySystemDescriptor;
import com.sedec.dvb.ts.si.descriptors.SateliteDeliverySystemDescriptor;
import com.sedec.dvb.ts.si.descriptors.ScramblingDescriptor;
import com.sedec.dvb.ts.si.descriptors.ServiceDescriptor;
import com.sedec.dvb.ts.si.descriptors.ServiceListDescriptor;
import com.sedec.dvb.ts.si.descriptors.ServiceMoveDescriptor;
import com.sedec.dvb.ts.si.descriptors.ShortEventDescriptor;
import com.sedec.dvb.ts.si.descriptors.ShortSmoothingBufferDescriptor;
import com.sedec.dvb.ts.si.descriptors.SimpleApplicationBoundaryDescriptor;
import com.sedec.dvb.ts.si.descriptors.SimpleApplicationLocationDescriptor;
import com.sedec.dvb.ts.si.descriptors.StreamIdentifierDescriptor;
import com.sedec.dvb.ts.si.descriptors.StuffingDescriptor;
import com.sedec.dvb.ts.si.descriptors.SubtitlingDescriptor;
import com.sedec.dvb.ts.si.descriptors.TelephoneDescriptor;
import com.sedec.dvb.ts.si.descriptors.TeletextDescriptor;
import com.sedec.dvb.ts.si.descriptors.TerrestrialDeliverySystemDescriptor;
import com.sedec.dvb.ts.si.descriptors.TimeShiftedEventDescriptor;
import com.sedec.dvb.ts.si.descriptors.TimeShiftedServiceDescriptor;
import com.sedec.dvb.ts.si.descriptors.TransportProtocolDescriptor;
import com.sedec.dvb.ts.si.descriptors.UnknownDescriptor;
import com.sedec.dvb.ts.si.descriptors.VBIDataDescriptor;
import com.sedec.dvb.ts.si.descriptors.VBITeletextDescriptor;
import com.sedec.dvb.ts.si.descriptors.VideoDecodeControlDescriptor;
