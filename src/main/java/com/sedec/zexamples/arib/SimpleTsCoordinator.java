...
import com.sedec.arib.b10.TableFactory;
import com.sedec.arib.b10.tables.ProgramAssociationTable;
import com.sedec.arib.b10.tables.ProgramMapTable;
import com.sedec.arib.extractor.ts.TsDemultiplexer;
import com.sedec.base.Table;
import com.sedec.util.CommandLineParam;

/**
 * SimpleTsCoordinator is an example which's using TsDemultiplexer of com.sedec to get information
