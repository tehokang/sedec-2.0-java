...
import com.sedec.arib.tlv.container.mmtp.mfu.ParserException;
...
public final class CodecSpecificDataUtil {
   ...
   */
  public static Object[] parseAacAudioSpecificConfig(byte[] audioSpecificConfig)
   ...
   * @throws ParserException If the AudioSpecificConfig cannot be parsed as it's not supported.
   */
  public static Object[] parseAacAudioSpecificConfig(ParsableBitArray bitArray,
    ...
    return new Object[] {sampleRate, channelCount};
  }
